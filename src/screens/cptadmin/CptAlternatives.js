...
export default class CptAlternatives extends Component {
    ...
    init_visit = () => {
        this.setState({
            ...
            alternatives_list: Global.cpt_admin_json.surgeryAlt
    ...
    show_alert() {
        ...
        [
            ...
            {text: 'OK', onPress: () => this.delete_alternative(this.state.selected_right_menu_index)},
        ],
        { cancelable: true })
    }
    ...
    delete_alternative(index) {
        var alternatives_list = this.state.alternatives_list;
        alternatives_list.splice(index, 1);
        this.setState({
            alternatives_list: alternatives_list
        })
        Global.cpt_admin_json.surgeryAlt = alternatives_list;
    }
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {styles.menu_bar}>
                ...
                <View style = {{width: '60%', height: '100%', justifyContent: 'center'}}>
                    <Text style = {{fontSize: 18, color: '#ffffff'}}>Alternatives</Text>
                </View>
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectAlternative", {prev_screen: "CptAlternatives"})}>
