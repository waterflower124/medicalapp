...
export default class CptRisks extends Component {
    ...
    init_visit = () => {
        this.setState({
            ...
            risk_list: Global.cpt_admin_json.surgeryRisk,
    ...
    right_menu_view_style = function () {
        ...
        return {
            ...
            height: 50,
            position: 'absolute',
            // top: item_y_pos_array[this.state.selected_right_menu_index] + 20,
            top: top_pos,
            right: 0,
            borderWidth: 1,
            borderColor: '#c0c0c0',
    ...
    show_alert(index) {
        ...
        [
            ...
            {text: 'OK', onPress: () => this.delete_risk(this.state.selected_right_menu_index)},
        ],
        { cancelable: true })
    }
    ...
    delete_risk(index) {
        ...
        Global.cpt_admin_json.surgeryRisk = risk_list;
    }
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {styles.menu_bar}>
                ...
                <View style = {{width: '60%', height: '100%', justifyContent: 'center'}}>
                    <Text style = {{fontSize: 18, color: '#ffffff'}}>Risks</Text>
                </View>
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectRisk", {prev_screen: "CptRisks"})}>
