...
export default class IcdSymptoms extends Component {
    ...
    init_visit = () => {
        this.setState({
            ...
            symptom_list: Global.icd_admin_json.symptoms
    ...
    show_alert = (action_type) => {
        ...
        var symptom_list = this.state.symptom_list;
        symptom_list[this.state.selected_right_menu_index].clicked = !symptom_list[this.state.selected_right_menu_index].clicked;
        this.setState({
            symptom_list: symptom_list
        });
    ...
    delete_symptom = async(index) => {
        var symptom_list = this.state.symptom_list;
        symptom_list.splice(index, 1);
        this.setState({
            symptom_list: symptom_list
        });
        Global.icd_admin_json.symptoms = symptom_list;
        this.setState({
            selected_right_menu_index: -1
        });
    }
    ...
    add_new_symptoms() {
        this.hidden_right_menu();
        this.props.navigation.navigate("SelectSymptom", {prev_screen: "IcdSymptoms"});
    }
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {styles.menu_bar}>
                ...
                <View style = {{width: '60%', height: '100%', justifyContent: 'center'}}>
                    <Text style = {{fontSize: 18, color: '#ffffff'}} numberOfLines = {1} renderTruncatedFooter = {() => null}>Symptoms</Text>
                </View>
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.add_new_symptoms()}>
