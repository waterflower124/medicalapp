...
export default class Symptoms extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.symptoms != null) {
            this.setState({
    ...
    delete_symptom(index) {
        ...
        Global.edit_case_json.symptoms = symptom_list;
    }
    ...
    render() {
        ...
        {/* {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectSymptom", {prev_screen: "Symptoms"})}>
