...
export default class Alternatives extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.alternatives != null) {
            this.setState({
    ...
    delete_alternative(index) {
        ...
        Global.edit_case_json.alternatives = alternatives_list;
    }
    ...
    render() {
        ...
        {/* {
            ...
            <View style = {{position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, zIndex: 100}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectAlternative", {prev_screen: "Alternatives"})}>
