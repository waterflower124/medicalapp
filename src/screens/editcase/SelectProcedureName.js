...
export default class SelectProcedureName extends Component {
    ...
    go_back() {
        ...
        } else if(this.state.prev_screen == "CptMaster") {
    ...
    async select_procedure_name(item) {
        if(this.state.prev_screen == "Procedure") {
            ...
            Global.cpt_admin_json.medproc.procAlias = item.procAlias;
            Global.cpt_admin_json.medproc.estado = item.estado;
            Global.cpt_admin_json.medproc.procCode = item.procCode;
            Global.cpt_admin_json.medproc.procDesc = item.procDesc;
            Global.cpt_admin_json.medproc.riskFactor = item.riskFactor;
            Global.cpt_admin_json.medproc.successRate = item.successRate;
            ...
            .then(async data => {
                Global.cpt_admin_json.surgeryAlt = data.surgeryAlt;
                Global.cpt_admin_json.surgeryInst = data.surgeryInst
                Global.cpt_admin_json.surgeryRisk = data.surgeryRisk;
            })
            .catch(function(error) {
                Alert.alert('Warning!', "Network error");
            });
