...
export default class LabTests extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.labs != null) {
            this.setState({
    ...
    delete_symptom(index) {
        ...
        var labs_list = this.state.labs_list;
        labs_list.splice(index, 1);
        this.setState({
            labs_list: labs_list
        });
        Global.edit_case_json.labs = labs_list;
    }

    change_labStatus(labStatus) {
        this.hidden_right_menu();
        var labs_list = this.state.labs_list;
        labs_list[this.state.selected_right_menu_index].labStatus = labStatus;
        this.setState({
            labs_list: labs_list
        });
        Global.edit_case_json.labs = labs_list;
    ...
    render() {
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                <ScrollView style = {{width: '90%'}} showsVerticalScrollIndicator = {false}>
                    ...
                    }
                    {
                        ...
                        <View style = {this.right_menu_view_style()}>
                            ...
                            <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus("N")}>
                                <Text style = {styles.right_menu_text}>Negative</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus("P")}>
                                <Text style = {styles.right_menu_text}>Positive</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus("I")}>
                                <Text style = {styles.right_menu_text}>Inconclusive</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus("O")}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectLab", {prev_screen: "LabTests"})}>
