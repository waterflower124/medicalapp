...
export default class LabTests extends Component {
    ...
    change_labStatus(index, labStatus) {
        this.hidden_right_menu();
        var labs_list = this.state.labs_list;
        labs_list[index].labStatus = labStatus;
        this.setState({
            labs_list: labs_list
        });
        Global.edit_case_json.labs = labs_list;
                        ...
                        <View key = {index} style = {{width: '100%', flexDirection: 'row', marginTop: 20, zIndex: 1000-index}}>
                            ...
                            </View>
                            {
                                ...
                                <View style = {[styles.right_menu_view, {zIndex: 1000-index}]}>
                                    ...
                                    <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus(index, "N")}>
                                        <Text style = {styles.right_menu_text}>Negative</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus(index, "P")}>
                                        <Text style = {styles.right_menu_text}>Positive</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus(index, "I")}>
                                        <Text style = {styles.right_menu_text}>Inconclusive</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style = {styles.right_menu_item} onPress = {() => this.change_labStatus(index, "O")}>
