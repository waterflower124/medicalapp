...
export default class Treats extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.prodiags != null) {
            this.setState({
    ...
    delete_treat(index) {
        var prodiags_list = this.state.prodiags_list;
        prodiags_list.splice(index, 1);
        this.setState({
            prodiags_list: prodiags_list
        });
        Global.edit_case_json.prodiags = prodiags_list;
    }
    ...
    render() {
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectTreat", {prev_screen: "Treats"})}>
