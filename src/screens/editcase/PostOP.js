...
export default class PostOP extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.instructions != null) {
            this.setState({
    ...
    delete_postop(index) {
        ...
        Global.edit_case_json.instructions = instructions_list;
    }
    ...
    render() {
        ...
        {/* {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectInstruction", {prev_screen: "PostOP"})}>
