...
export default class Prescription extends Component {
    ...
    init_visit = () => {
        ...
        if(Global.edit_case_json.meds != null) {
            this.setState({
    ...
    show_alert() {
        ...
        [
            ...
            {text: 'OK', onPress: () => this.delete_med(this.state.selected_right_menu_index)},
        ],
        { cancelable: true })
    }
    ...
    delete_med(index) {
        this.hidden_right_menu();
        var meds_list = this.state.meds_list;
        meds_list.splice(index, 1);
        this.setState({
            meds_list: meds_list
        })
        Global.edit_case_json.meds = meds_list;
    }
    ...
    render() {
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                ...
                <TouchableOpacity style = {styles.add_button} onPress = {() => this.props.navigation.navigate("SelectMedicine", {prev_screen: "Prescription"})}>
