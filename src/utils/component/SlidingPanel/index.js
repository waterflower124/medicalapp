...
export default class SlidingPanel extends Component {
  ...
  render() {
    return (
      <View style={this.props.panelPosition === 'bottom' ? {position: 'absolute', bottom: -this.props.headerLayoutHeight / 1.5} : {position: 'absolute', top: -this.props.headerLayoutHeight / 1.5}}>
        {
